...
public class JJJJJ {
    ...
    /**
     * jsonInfo : {"code":"0","data":{"url":"/hotels/order_detail.htm?recordId=40"},"msg":"成功"}
     */
    ...
    public static class JsonInfoBean {
        /**
         * code : 0
         * data : {"url":"/hotels/order_detail.htm?recordId=40"}
         * msg : 成功
         */
        ...
        public static class DataBean {
            /**
             * url : /hotels/order_detail.htm?recordId=40
             */
