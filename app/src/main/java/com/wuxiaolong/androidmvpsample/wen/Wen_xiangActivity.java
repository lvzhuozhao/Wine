...
public class Wen_xiangActivity extends MvpActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_w__wshouyin);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.jiezhnag_back:
                ...
                break;
            case R.id.yiyi_btn:
                Intent intent = new Intent(Wen_xiangActivity.this, Wen_jiezhangwayActivity.class);
                ...
                break;
            case R.id.yiyi_btn1:
                Intent  intent1=new Intent(Wen_xiangActivity.this,Wen_jieqianActivity.class);
                ...
                break;
            case R.id.yiyi_btn2:
                Intent  intent2=new Intent(Wen_xiangActivity.this,Wen_GuazhangActivity.class);
